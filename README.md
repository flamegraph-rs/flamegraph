...
<div align="center" style="text-align:center">
  <a href="example.svg"><img src="example_cropped.png" alt="colorized flamegraph output" width="85%"></a>

  <em>Generate flamegraphs for all applications, with additional support for Cargo projects. No perl or pipes required <3 </em>
</div>

Built using Rust, on top of [@jonhoo's](https://github.com/jonhoo) wonderful [Inferno](https://github.com/jonhoo/inferno) all-rust flamegraph generation library!
